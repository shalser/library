        ...
        <div class="container">
            ...
            <h1 class="my-md-5 my-4">
                <label for="editMaterialTitle">
                    <input type="text" value="<?= $title; ?>" id="editMaterialTitle">
                </label>
            </h1>
            <div class="row mb-3">
                <div class="col-lg-6 col-md-8">
                    <div class="d-flex text-break">
                        ...
                        <label for="editMaterialAuthor"></label><input type="text" value="<?= $author; ?>" id="editMaterialAuthor">
                    </div>
                    <div class="d-flex text-break">
                        <p class="col fw-bold mw-25 mw-sm-30 me-2">Тип</p>
                        <label for="editMaterialType"></label><input type="text" value="<?= $type; ?>" id="editMaterialType">
                    </div>
                    <div class="d-flex text-break">
                        <p class="col fw-bold mw-25 mw-sm-30 me-2">Категория</p>
                        <label for="editMaterialCategory"></label><input type="text" value="<?= $category; ?>" id="editMaterialCategory">
                    </div>
                    <div class="d-flex text-break">
                        <p class="col fw-bold mw-25 mw-sm-30 me-2">Описание</p>
                        <label for="editMaterialDescription"></label><input type="text" value="<?= $description; ?>" id="editMaterialDescription">
                    </div>
                </div>
            </div>
