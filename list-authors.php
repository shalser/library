...
?>
    ...
    <div class="content">
        ...
        <div class="container">
            <h1 class="my-md-5 my-4">Авторы</h1>
            <a class="btn btn-primary mb-4" href="create-authors.php" role="button">Добавить</a>
            <div class="row">
                <div class="col-md-6">
                            ...
                            <span class="me-3">
                                ...
                                <div class="text-nowrap">
                                    <form action="actions/editTag.php" method="post">
                                        <input type='hidden' name='id_tag' value='<?= $author['id']; ?>' />
